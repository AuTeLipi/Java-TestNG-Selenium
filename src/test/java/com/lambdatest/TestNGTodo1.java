...
public class TestNGTodo1 {
    ...
    public void setup(Method m, ITestContext ctx) throws MalformedURLException {
        ...
        // Use unique user data directory to prevent session errors
        options.addArguments("user-data-dir=/tmp/unique_chrome_profile_" + System.currentTimeMillis());

        // Optional flags to disable extensions and info bars
    ...
    public void basicTest() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("sampletodotext")));
        ...
        // Wait for new item to appear and validate
